...
export const en = {
  ...
  playit: {
    ...
    overviewSection: "Playit overview",
    serviceColumn: "Service",
    agentAccount: "Agent account",
    webAccount: "Web account",
    webAccountSignedOut: "Signed out",
    accountNumber: "Account #{id}",
    ownershipMatched: "This agent belongs to the signed-in account.",
    ownershipForeign: "This agent belongs to another Playit account.",
    ownershipNotVerified: "Not verified — sign in to verify this agent.",
    ownershipNoAgent: "No Playit agent configured.",
