...
export const en = {
  ...
  playit: {
    ...
    accountSection: "Playit account",
    signInTitle: "Sign in to Playit",
    signInExplain: "Connect your Playit account to manage agents and tunnels. Credentials stay between you and Playit.",
    totpTitle: "Two-factor verification",
    email: "Email",
    password: "Password",
    signIn: "Sign in",
    signingIn: "Signing in…",
    signInFailed: "Playit sign-in failed.",
    totpCode: "Authenticator code",
    totpPrompt: "Enter the 6-digit code from your authenticator app.",
    verify: "Verify",
    signedIn: "Signed in to Playit.",
    signedInAs: "Signed in as account {id} ({status}).",
    readOnly: "read-only",
    signOut: "Sign out",
    signedOut: "Signed out of Playit.",
    connectAccount: "Connect account",
    setupDone: "Playit agent connected.",
    setupPending: "Claim accepted; the agent is still connecting.",
    agentsSection: "Account agents",
    currentAgent: "Current agent",
    moveTunnelsTo: "Move tunnels to…",
    unassignTunnels: "Unassign tunnels",
    disableTunnels: "Disable tunnels",
    deleteAgent: "Delete",
    deleteAgentTitle: "Delete agent {name}?",
    deleteAgentMoveBody: "Its tunnels will move to {target}.",
    deleteAgentUnassignBody: "Its tunnels will be unassigned (kept, but detached).",
    agentDeleted: "Playit agent deleted.",
    disconnectAgent: "Disconnect agent",
    disconnectAgentTitle: "Disconnect the Playit agent?",
    disconnectAgentBody:
      "Removes the agent secret and restarts into setup mode. Tunnels stop; the account login stays.",
    agentDisconnected: "Playit agent disconnected.",
    reconnectAgent: "Reconnect agent",
    agentReconnected: "Playit agent reconnected.",
    ...
    serverStates: {
      ...
      missing: "Tunnel missing",
      account_mismatch: "Playit account changed",
      agent_mismatch: "Different Playit agent",
      ambiguous: "Ambiguous tunnel match",
    ...
    reconcileServer: "Reconcile",
    repairServer: "Repair tunnel",
    forgetServer: "Forget association",
    forgetServerBody: "Forget the local association without deleting the remote Playit tunnel.",
    serverAssociationForgotten: "Local Playit association forgotten.",
    ...
    noAgents: "No agents are registered on this account yet.",
    createTunnelTitle: "Create a tunnel",
    createTunnelExplain:
      "Create a standalone tunnel pointing at this machine. Game-server tunnels stay managed from the server list above.",
    tunnelName: "Name (optional)",
    tunnelPort: "Local port",
    tunnelProtocol: "Protocol",
    tunnelAddress: "Local address",
    createTunnel: "Create tunnel",
    creatingTunnel: "Creating…",
    invalidTunnelPort: "Enter a port between 1 and 65535.",
    createBeforeConnect: "Connect Playit before creating a tunnel.",
    ...
    signOutExplain: "Removes the account login only. The agent keeps running.",
    agentSection: "Playit agent",
    agentControlsExplain:
      "The agent runs independently of the account login. These controls stay available while signed out.",
    noAgentId: "No agent is configured yet.",
    ownershipSection: "Account ownership",
    ownershipStates: {
      matched: "Matched",
    ...
    ownershipMatchedExplain: "This agent belongs to the signed-in account.",
    ownershipUnknownExplain: "Sign in to verify which account owns this agent.",
    ownershipNoAgentExplain: "Claim an agent before verifying ownership.",
    ...
    tunnelSource: "Source",
    sourceAccount: "Playit account",
    sourceAgent: "Local agent",
    sourceUnavailable: "Unavailable",
    signInToManage: "Sign in to manage tunnels.",
    tunnelsUnavailable: "Tunnel listing is unavailable while Playit is starting.",
    changeAccount: "Change account",
    changeAccountTitle: "Change Playit account",
    changeAccountExplain:
      "Disconnects the current agent, signs out, and claims a fresh agent under the new account. Previous tunnels are left behind.",
    changeAccountWarning:
      "The current account owns this agent. Switching abandons its tunnels. Switch anyway?",
    agentNameOptional: "Agent name (optional)",
    switchingAccount: "Switching…",
    accountChanged: "Playit account changed.",
    serversRecovered: "Recovered {recovered} of {total} server tunnels.",
    totpPendingAfterChange: "Verify the code to finish switching accounts.",
  },
  ...
  server: {
    ...
    preparing:
      "Preparing Java and server files. This can take a few minutes on a first start — progress appears above. Cancel to abandon it.",
  ...
  console: {
    title: "Console",
    live: "live",
    connected: "Console stream connected",
    reconnecting: "Console stream reconnecting…",
    disconnectedState: "Console stream disconnected",
